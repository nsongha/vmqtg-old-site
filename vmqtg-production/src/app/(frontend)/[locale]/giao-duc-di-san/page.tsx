...
const SLUG = 'giao-duc-di-san'
const TITLES = {
  vi: 'Giáo dục di sản | Văn Miếu',
  en: 'Heritage Education | Temple of Literature',
  fr: 'Éducation au patrimoine | Temple de la Littérature',
} as const
